...
@Service
public class ReceivedDocumentFromClientService {

    private final ReceivedDocumentFromClientRepository receivedDocumentFromClientRepository;
    private final CompanyRepository companyRepository;

    public ReceivedDocumentFromClientService(ReceivedDocumentFromClientRepository receivedDocumentFromClientRepository, CompanyRepository companyRepository) {
